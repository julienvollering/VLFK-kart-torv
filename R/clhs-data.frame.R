# From https://github.com/pierreroudier/clhs/blob/master/R/clhs-data.frame.R
...
clhs.data.frame <- function(
  ...
  if (use.cpp) {
    ...
    if(is.null(include)){
      ...
      can.include <- 1:nrow(dat) ## JV: issue here? But will fixing conflict with the C++ below?
    }
